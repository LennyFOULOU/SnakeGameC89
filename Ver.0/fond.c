...
void dessinerMurs() { /* Dessiner les murs en remplissant des rectangles */
  ...
  RemplirRectangle(0, 0, LARGEUR_FENETRE, TAILLE_CASE * 2);                                  /* Mur du haut */
  RemplirRectangle(0, HAUTEUR_FENETRE - TAILLE_CASE * 2, LARGEUR_FENETRE, TAILLE_CASE * 2);  /* Mur du bas */
  RemplirRectangle(0, 0, TAILLE_CASE * 2, HAUTEUR_FENETRE);                                  /* Mur de gauche */
  RemplirRectangle(LARGEUR_FENETRE - TAILLE_CASE * 2, 0, TAILLE_CASE * 2, HAUTEUR_FENETRE);  /* Mur de droite */
